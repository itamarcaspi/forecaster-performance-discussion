...
subtitle: "Discussion"
author: "Itamar Caspi"
date: "July 9, 2019 (updated: `r Sys.Date()`)"
output:
...
- The authors assemble an impressive and unique dataset:

  - Inflation and interest rate forecasts made by __480__ experts from __440__ institutions, bofore and after the global finance crisis.
  
  - A rich set of forecasters charateristics: experience (type and time), gender, education (level, type, and quality), and affiliation (type and place).
  
- Characterize the factors associated with forecaster survival rate, as well as three measures of performance (accuracy, courage, and instability)
...
The authors use a two-way fixed effect panel data model to estimate the effects of various forecaster charateristics on forecasting performance:

$$y_{it}=x_{it}^{\prime} \beta+\alpha_{i}+\theta_{t}+\varepsilon_{it}$$
where $y_{it}$ is a measuere of forecasting performence (accuracy, courage, and instability), and $x_i$ is a vector of forecaster charateristics.

__RESEARCH QUESTION:__ Which factors __affect__ forecasting performance (and survival rate)? 

__FINDINGS:__

>  _"We show that the level and quality of the education, the localization and type of their affiliation, and their experience, as a forecaster or in a central bank or academia, are critical characteristics for __improving__ these behaviors."_
...
__OPTION 3:__ Stay in the realm of descriptive analysis, but change the subject, e.g., 
...
knitr::include_graphics("figs/football_dist.jpg")
...
knitr::include_graphics("figs/football_flow.jpg")
...
- Model: Why is it essential (it is)?
